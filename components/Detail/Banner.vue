<template>
  ...
  >
    ...
    <div
      class="absolute h-full px-8 md:px-12 py-6 md:py-12 text-white md:text-black"
    >
      <div
        v-if="novelsDetailData && novelsDetailData[id - 1]"
        class="md:pt-4 md:mx-0 mx-4 py-2 flex flex-wrap-reverse h-full"
      >
        <div class="w-3/4 order-last md:order-none flex-col flex">
          ...
          <div class="md:flex pt-8 hidden">
            <button
              class="px-8 py-3 bg-blue-600 rounded-full text-white font-semibold mr-4"
            >
              Mulai lihat EP.1
            </button>
            <button class="px-8 py-3 flex bg-slate-100 rounded-full">
              <svg
          ...
          <div class="flex justify-between md:hidden mt-auto">
            <div class="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              ...
              <p class="justify-self-end text-base ml-1">51.6M</p>
            </div>
            <div class="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p class="justify-self-end text-base ml-1">1.6M</p>
            </div>
            <div class="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p class="justify-self-end text-base ml-1">4.7</p>
            </div>
          </div>
        </div>
